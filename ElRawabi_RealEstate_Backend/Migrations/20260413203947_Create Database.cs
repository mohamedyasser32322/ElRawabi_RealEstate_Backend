        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBuildings = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientBuyerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Notifications_Buyers_RecipientBuyerId",
                        column: x => x.RecipientBuyerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_RecipientBuyerId",
                table: "Notifications",
                column: "RecipientBuyerId");
