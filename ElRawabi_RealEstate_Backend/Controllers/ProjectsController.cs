...
public class ProjectsController : ControllerBase
{
    ...
    [HttpGet] public async Task<IActionResult> GetAll() => Ok(await _projectService.GetAllProjectsAsync());
    [HttpGet("{id}")] public async Task<IActionResult> GetById(int id) => Ok(await _projectService.GetProjectByIdAsync(id));
