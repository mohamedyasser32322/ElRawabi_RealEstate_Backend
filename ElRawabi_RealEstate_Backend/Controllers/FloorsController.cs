...
public class FloorsController : ControllerBase
{
    ...
    [HttpGet] public async Task<IActionResult> GetAll() => Ok(await _floorService.GetAllFloorsAsync());
    [HttpGet("{id}")] public async Task<IActionResult> GetById(int id) => Ok(await _floorService.GetFloorByIdAsync(id));
